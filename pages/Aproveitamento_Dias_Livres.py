...
def puxar_dados_phoenix():
    ...
    st.session_state.df_sales = gerar_df_sales('test_phoenix_natal')
    ...
    st.session_state.df_router_2 = gerar_df_router('test_phoenix_natal')

    lista_combos = ['Combo  Flex 02 passeios ', 'Combo  Flex 03 passeios ']
    ...
    st.session_state.df_router_2 = st.session_state.df_router_2[(st.session_state.df_router_2['Status do Servico']!='CANCELADO') & (st.session_state.df_router_2['Status da Reserva']!='CANCELADO') & 
                                                            ...
                                                            (~st.session_state.df_router_2['Servico'].isin(lista_combos))].reset_index(drop=True)
...
st.title('Aproveitamento Dias Livres - Natal')
